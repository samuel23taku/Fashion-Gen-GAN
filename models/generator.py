...
class Generator(nn.Module):
    def __init__(self, input_noise_vector_size, feature_map_depth, number_of_channels) -> None:
        ...
        self.main = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.ConvTranspose2d(in_channels=feature_map_depth * 8, out_channels=feature_map_depth * 4, kernel_size=4,
            ...
            nn.ReLU(True),
            nn.ConvTranspose2d(in_channels=feature_map_depth * 2, out_channels=number_of_channels, kernel_size=4,
                               stride=2, padding=0, bias=False),
            nn.Tanh()
        )
